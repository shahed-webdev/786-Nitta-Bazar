<%@ Page Title="Referral Commission" Language="C#" MasterPageFile="~/Member.Master" AutoEventWireup="true" CodeBehind="Referral_Bonus_Details.aspx.cs" Inherits="NittaBazar.AccessMember.Bonus_Details.Referral_Bonus_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
   ...
   <asp:GridView ID="Referral_GridView" runat="server" AutoGenerateColumns="False" CssClass="mGrid" DataSourceID="Referral_SQL" AllowPaging="True" PageSize="50">
      <Columns>
         ...
         <asp:BoundField DataField="Member_Package_Short_Key" HeaderText="Upgraded Pack." SortExpression="Member_Package_Short_Key" />
         <asp:BoundField DataField="Package_Point" HeaderText="Package Point" SortExpression="Package_Point" />
