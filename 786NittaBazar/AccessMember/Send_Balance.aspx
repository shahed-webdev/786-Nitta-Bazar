<%@ Page Title="Balance Transfer" Language="C#" MasterPageFile="~/Member.Master" AutoEventWireup="true" CodeBehind="Send_Balance.aspx.cs" Inherits="NittaBazar.AccessMember.Send_Balance" %>
...
UPDATE  Fund_Transition_Code SET IS_Used = 1 WHERE (Transition_CodeID = @Transition_CodeID)">
            ...
            <asp:SqlDataSource ID="T_Code_SQL" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" InsertCommand="Add_Transition_Code" SelectCommand="SELECT * FROM Fund_Transition_Code" InsertCommandType="StoredProcedure" OnInserted="T_Code_SQL_Inserted">
                <InsertParameters>
                    <asp:Parameter Direction="ReturnValue" Name="RETURN_VALUE" Size="50" Type="Int32" />
                    <asp:SessionParameter Name="Sent_RegistrationID" SessionField="RegistrationID" />
