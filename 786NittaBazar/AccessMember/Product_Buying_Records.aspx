<%@ Page Title="Product Buying Records" Language="C#" MasterPageFile="~/Member.Master" AutoEventWireup="true" CodeBehind="Product_Buying_Records.aspx.cs" Inherits="NittaBazar.AccessMember.Product_Buying_Records" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="table-responsive">
        ...
        <asp:SqlDataSource ID="SellingeportSQL" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" SelectCommand="SELECT Shopping.ShoppingID, Shopping.Shopping_SN, Shopping.ShoppingAmount, Shopping.ShoppingPoint, Shopping.ShoppingDate, Seller.Shop_Name FROM Shopping INNER JOIN Seller ON Shopping.SellerID = Seller.SellerID INNER JOIN Registration ON Seller.SellerRegistrationID = Registration.RegistrationID WHERE (CAST(Shopping.ShoppingDate AS DATE) BETWEEN ISNULL(@From_Date, '1-1-1000') AND ISNULL(@To_Date, '1-1-3000')) AND (Shopping.MemberID = @MemberID)" CancelSelectOnNullParameter="False">
            <SelectParameters>
