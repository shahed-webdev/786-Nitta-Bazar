        ...
        protected void Withdraw_Button_Click(object sender, EventArgs e)
        {
            ...
            if (IsSMS.Is_Withdraw)
            {
                ...
                if ((withdraw_Balance + Withdraw_Request) <= Available_Balance)
                {
                    ...
                    string Msg = "Your withdrawal verification code is: " + Num + ". Prodive this code to administration for receive balance. nittabazar.xyz";
