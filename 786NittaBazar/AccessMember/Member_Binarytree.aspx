<%@ Page Title="Genealogical Tree" Language="C#" MasterPageFile="~/Member.Master" AutoEventWireup="true" CodeBehind="Member_Binarytree.aspx.cs" Inherits="NittaBazar.AccessMember.Member_Binarytree" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="CSS/Member_BinaryTree.css?v=2.2" rel="stylesheet" />
</asp:Content>
        ...
        <div class="Contain">
            ...
            <div class="Main_Left">
                <asp:FormView ID="ML_FormView" runat="server" DataSourceID="ML_SQL" Width="100%" DataKeyNames="MemberID">
                    ...
                    <EmptyDataTemplate>
                        <asp:FormView ID="Add_FormView" runat="server" DataSourceID="Add_SQL">
                            <ItemTemplate>
                                <div class="Add_User">
                                    <a href="Add_New_Member.aspx?PID=<%# Eval("UserName") %>&PType=<%# Eval("PositionType") %>"><i class="fa fa-user-plus"></i></a>
                                </div>
                            </ItemTemplate>
                        </asp:FormView>
                        <asp:SqlDataSource ID="Add_SQL" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>"
                            SelectCommand="SELECT Registration.UserName, 'Left' AS PositionType FROM Member INNER JOIN  Registration ON Member.MemberRegistrationID = Registration.RegistrationID WHERE (Member.Left_Status = 0) AND (Member.MemberID = @MemberID)">
                            <SelectParameters>
            ...
            <div class="Main_Right">
                <asp:FormView ID="MR_FormView" runat="server" DataSourceID="MR_SQL" Width="100%" DataKeyNames="MemberID">
                    ...
                    <EmptyDataTemplate>
                        ...
                        <asp:SqlDataSource ID="Add_SQL" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>"
                            SelectCommand="SELECT Registration.UserName, 'Right' AS PositionType FROM Member INNER JOIN  Registration ON Member.MemberRegistrationID = Registration.RegistrationID WHERE (Member.Right_Status = 0) AND (Member.MemberID = @MemberID)">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="Main_FormView" Name="MemberID" PropertyName="SelectedValue" />
                            </SelectParameters>
                        </asp:SqlDataSource>
