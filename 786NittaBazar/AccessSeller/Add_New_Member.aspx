<%@ Page Title="Add New Customer" Language="C#" MasterPageFile="~/Seller.Master" AutoEventWireup="true" CodeBehind="Add_New_Member.aspx.cs" Inherits="NittaBazar.AccessSeller.Add_New_Member" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
				...
				<asp:RequiredFieldValidator ID="Required" runat="server" ControlToValidate="PhoneTextBox" CssClass="EroorStar" ForeColor="Red" ValidationGroup="1">*</asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="PhoneTextBox" CssClass="EroorStar" ErrorMessage="Invalid" ValidationExpression="(88)?((011)|(015)|(016)|(017)|(018)|(019)|(013)|(014))\d{8,8}" ValidationGroup="1"></asp:RegularExpressionValidator>
                </label>
            ...
            <div class="form-group col-md-3">
                <label>
                    Area*
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="AreaDropDownList" CssClass="EroorStar" ForeColor="Red" SetFocusOnError="true" ValidationGroup="1">*</asp:RequiredFieldValidator>
                </label>
                <asp:DropDownList ID="AreaDropDownList" CssClass="form-control" runat="server" DataSourceID="AreaSQL" DataTextField="OfficeAreaName" DataValueField="MemberOfficeAreaID" AppendDataBoundItems="True">
                    <asp:ListItem Value="">[ SELECT AREA TO ASSIGN ]</asp:ListItem>
                </asp:DropDownList>
                <asp:SqlDataSource ID="AreaSQL" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" SelectCommand="SELECT [MemberOfficeAreaID], [OfficeAreaName] FROM [Member_Office_Area]"></asp:SqlDataSource>
            </div>
            <%}
                }%>
        </div>
    ...
    <div class="well">
        ...
        <div id="Product-info" class="alert alert-success">
            ...
            <input id="Seller_Com_hf" type="hidden" />
        </div>
        ...
        <asp:HiddenField ID="GTSeller_CommissionHF" runat="server" />
    </div>
    ...
    <asp:SqlDataSource ID="MemberSQL" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" InsertCommand="INSERT INTO Member (MemberRegistrationID, InstitutionID, Referral_MemberID, PositionMemberID, PositionType, Is_Identified, Identified_Date, MemberOfficeAreaID, Joined_By_RegistrationID,DecimalPoint_Carry) VALUES ((SELECT IDENT_CURRENT('Registration')), @InstitutionID, @Referral_MemberID, @PositionMemberID, @PositionType, 1, GETDATE(), @MemberOfficeAreaID, @Joined_By_RegistrationID,@DecimalPoint_Carry)" SelectCommand="SELECT * FROM [Member]" UpdateCommand="Add_Update_CarryMember" UpdateCommandType="StoredProcedure">
        <InsertParameters>
            ...
            <asp:ControlParameter ControlID="AreaDropDownList" Name="MemberOfficeAreaID" PropertyName="SelectedValue" />
...
IF(@Join_SN = 0)
UPDATE  Shopping SET  Join_SN = @ShoppingID WHERE (ShoppingID = @ShoppingID)
ELSE
UPDATE  Shopping SET  Join_SN = @Join_SN WHERE (ShoppingID = @ShoppingID)"
    ...
    <asp:SqlDataSource ID="CIPCommissionSQL" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" InsertCommand="INSERT INTO Seller_CIP_Commission_Record(ShoppingID, SellerID, ShoppingAmount, ShoppingPoint, ComPercentage, Amount, Tax_Service_Charge) VALUES (@ShoppingID, @SellerID, @ShoppingAmount, @ShoppingPoint, @ComPercentage, @Amount, @Tax_Service_Charge)" SelectCommand="SELECT CIP_Distributor_Com, Tax_ServiceCharge FROM Institution" UpdateCommand="UPDATE Seller SET CIP_Income = CIP_Income + @CIP_Income WHERE (SellerID = @SellerID)">
        <InsertParameters>
            <asp:Parameter Name="ShoppingID" />
            <asp:SessionParameter Name="SellerID" SessionField="SellerID" />
            <asp:ControlParameter ControlID="GTpriceHF" Name="ShoppingAmount" PropertyName="Value" />
            <asp:ControlParameter ControlID="GTpointHF" Name="ShoppingPoint" PropertyName="Value" />
            <asp:Parameter Name="ComPercentage" />
            <asp:Parameter Name="Amount" />
            <asp:Parameter Name="Tax_Service_Charge" />
        </InsertParameters>
        <UpdateParameters>
            <asp:Parameter Name="CIP_Income" />
            <asp:SessionParameter Name="SellerID" SessionField="SellerID" />
        </UpdateParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="CIP_MemberSQL" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" SelectCommand="SELECT * FROM [Member]" UpdateCommand="UPDATE Member SET IsCIP = 1, Member_Package_Serial = 4, CIP_IncomeLimit = IIF(1.5 * @CIP_IncomeLimit &gt; 9000,9000,1.5 * @CIP_IncomeLimit) WHERE (MemberID = @MemberID)">
        <UpdateParameters>
            <asp:ControlParameter ControlID="GTpriceHF" Type="Double" Name="CIP_IncomeLimit" PropertyName="Value" />
            <asp:Parameter Name="MemberID" />
        </UpdateParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="WeeklyLimitSQL" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" InsertCommand="INSERT INTO Member_CIP_Weekly_Limit_Record(MemberID, LimitAmount, ShoppingID) VALUES (@MemberID, IIF(1.5 * @CIP_IncomeLimit &gt; 9000,9000,1.5 * @CIP_IncomeLimit), @ShoppingID)" SelectCommand="SELECT * FROM [Member_CIP_Weekly_Limit_Record]">
        <InsertParameters>
            <asp:ControlParameter ControlID="GTpriceHF" Name="CIP_IncomeLimit" PropertyName="Value" Type="Double" />
            <asp:Parameter Name="MemberID" Type="Int32" />
            <asp:Parameter Name="ShoppingID" />
        </InsertParameters>
    </asp:SqlDataSource>
    ...
    <script>
        ...
        function addToCart() {
            ...
            var Seller_Commission = $("#Seller_Com_hf").val();

            // create JavaScript Object
            if (Code != '' && Quantity != '' && ProductID != '') {
                if (Quantity < 1) { alert("Invalid Quantity"); return; }
                ...
                var item = { Code: Code, ProductID: ProductID, Name: Name, Quantity: Quantity, Unit_Price: Unit_Price, Unit_Point: Unit_Point, Seller_Commission: Seller_Commission };
                cart.push(item);
                saveCart();
                showCart();
        ...
        function getTotalComission() {
            var total = 0;
            $.each(cart, function () {
                total += this.Quantity * this.Seller_Commission;
            });
            $("[id*=GTSeller_CommissionHF]").val(total);
        }
        ...
        $(function () {
            ...
            $('[id*=ProductCodeTextBox]').typeahead({
                ...
                updater: function (item) {
                    ...
                    $("#Seller_Com_hf").val(map[item].Seller_Commission);
                    return item;
                }
            });
