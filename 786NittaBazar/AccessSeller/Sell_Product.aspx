<%@ Page Title="Sell Product" Language="C#" MasterPageFile="~/Seller.Master" AutoEventWireup="true" CodeBehind="Sell_Product.aspx.cs" Inherits="NittaBazar.AccessSeller.Sell_Product" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="col-md-6 well">
        ...
        <div id="user-info" class="alert-success">
            ...
            <asp:HiddenField ID="DecimalPoint_Carry_HF" runat="server" />
        </div>
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="QuantityTextBox" placeholder="Quantity" onkeypress="return isIntegerKey(event)" autocomplete="off" onDrop="blur();return false;" onpaste="return false" runat="server" CssClass="form-control"></asp:TextBox>
...
SELECT @ShoppingID = Scope_identity()"
        SelectCommand="SELECT * FROM [Shopping]" OnInserted="ShoppingSQL_Inserted" UpdateCommand="UPDATE Shopping SET Join_SN = @ShoppingID WHERE (ShoppingID = @ShoppingID)">
        <InsertParameters>
...
END"
    ...
    <asp:SqlDataSource ID="CIP_MemberSQL" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" SelectCommand="SELECT * FROM [Member]" UpdateCommand="IF EXISTS(SELECT MemberID FROM Member WHERE (MemberID = @MemberID) AND (CIP_IncomeLimit &lt;= 0) AND (IsCIP = 1))
BEGIN
UPDATE Member SET CIP_IncomeLimit = IIF(1.5 * @CIP_IncomeLimit &gt; 9000,9000,1.5 * @CIP_IncomeLimit) WHERE (MemberID = @MemberID)
INSERT INTO Member_CIP_Weekly_Limit_Record(MemberID, LimitAmount, ShoppingID) VALUES (@MemberID, IIF(1.5 * @CIP_IncomeLimit &gt; 9000,9000,1.5 * @CIP_IncomeLimit), @ShoppingID)
END">
        <UpdateParameters>
            <asp:ControlParameter ControlID="MemberID_HF" Name="MemberID" PropertyName="Value" />
    ...
    <asp:SqlDataSource ID="MemberCurryPintUpdateSQL" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" SelectCommand="SELECT * FROM [Member]" UpdateCommand="UPDATE [Member] SET [DecimalPoint_Carry] = @DecimalPoint_Carry WHERE [MemberID] = @MemberID">
        <UpdateParameters>
            <asp:Parameter Name="DecimalPoint_Carry" Type="Double" />
            <asp:ControlParameter ControlID="MemberID_HF" Name="MemberID" PropertyName="Value" Type="Int32" />
        </UpdateParameters>
    </asp:SqlDataSource>
        ...
        $(function () {
            ...
            $('[id*=MemberUserNameTextBox]').typeahead({
                ...
                updater: function (item) {
                    ...
                    $("[id$=DecimalPoint_Carry_HF]").val(map[item].DecimalPoint_Carry);
                    return item;
                }
            });
