<%@ Page Title="Sub-Category Links" Language="C#" MasterPageFile="~/Design.Master" AutoEventWireup="true" CodeBehind="Sub_Category_Links.aspx.cs" Inherits="NittaBazar.Access_Authority.Page_Link.Sub_Category_Links" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="container">
        <a href="Sub_Category.aspx?Category=<% =Request.QueryString["Category"] %>&CN=<% =Request.QueryString["CN"] %>">Back to Sub-Category</a>

        <h3>Insert URL Under <strong>'<% =Request.QueryString["CN"] %> > <% =Request.QueryString["SN"] %>'</strong></h3>
        ...
        <div class="form-inline">
            ...
            <div class="form-group">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="RoleDropDownList" CssClass="Rf-Error" ErrorMessage="*" ValidationGroup="1" InitialValue="0"></asp:RequiredFieldValidator>
            ...
            <div class="form-group">
                <asp:Button ID="SubmitButton" runat="server" OnClick="SubmitButton_Click" Text="Submit" ValidationGroup="1" CssClass="btn btn-primary" />
            </div>
        </div>

        <div class="table-responsive">
            <asp:GridView ID="InsertedLinkGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="LinkID,LinkCategoryID,RoleName" DataSourceID="Link_PagesSQL" Width="100%" OnRowUpdating="InsertedLinkGridView_RowUpdating" OnRowDeleting="InsertedLinkGridView_RowDeleting" CssClass="mGrid">
                <Columns>
...
DELETE FROM Link_Users WHERE (LinkID = @LinkID)"
                ...
                UpdateCommand="UPDATE Link_Pages SET Ascending = @Ascending, PageURL = @PageURL, PageTitle = @PageTitle, LinkCategoryID = @LinkCategoryID, SubCategoryID = @SubCategoryID WHERE (LinkID = @LinkID)" ProviderName="<%$ ConnectionStrings:DBConnectionString.ProviderName %>">
                <DeleteParameters>
