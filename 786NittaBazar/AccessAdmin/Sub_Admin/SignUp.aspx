<%@ Page Title="Sub-Admin Registration" Language="C#" MasterPageFile="~/Basic.Master" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="NittaBazar.AccessAdmin.Sub_Admin.SignUp" %>
                    ...
                    <div class="col-md-6 well">
                        ...
                        <div class="form-group">
                            <label>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="PhoneTextBox" CssClass="EroorStar" ErrorMessage="Invalid mobile no." ValidationExpression="(88)?((011)|(015)|(016)|(017)|(018)|(019)|(013)|(014))\d{8,8}" ValidationGroup="1" />
