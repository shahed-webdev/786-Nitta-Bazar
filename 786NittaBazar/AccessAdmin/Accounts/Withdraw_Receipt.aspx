<%@ Page Title="Withdraw Receipt" Language="C#" MasterPageFile="~/Basic.Master" AutoEventWireup="true" CodeBehind="Withdraw_Receipt.aspx.cs" Inherits="NittaBazar.AccessAdmin.Accounts.Withdraw_Receipt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <a href="Requested_Withdraw_List.aspx">Back To List</a>
