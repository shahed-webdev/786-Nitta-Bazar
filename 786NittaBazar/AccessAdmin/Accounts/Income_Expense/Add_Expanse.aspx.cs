...
namespace NittaBazar.AccessAdmin.Accounts
{
    public partial class Add_Expanse : System.Web.UI.Page
    {
        ...
        protected void CategoryNameGridView_RowDeleted(object sender, GridViewDeletedEventArgs e)
        {
            ...
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Don't Delete')", true);
        ...
        private bool Account_Balance()
        {
            ...
            AccountBalance_Cmd.Parameters.AddWithValue("@InstitutionID", Session["InstitutionID"].ToString());
