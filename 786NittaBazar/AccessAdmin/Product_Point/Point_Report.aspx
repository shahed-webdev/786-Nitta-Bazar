<%@ Page Title="Point & Service Charge Report" Language="C#" MasterPageFile="~/Basic.Master" AutoEventWireup="true" CodeBehind="Point_Report.aspx.cs" Inherits="NittaBazar.AccessAdmin.Product_Point.Point_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <asp:FormView ID="MatchingFormView" runat="server" DataSourceID="MatchingSQL" Width="100%">
                <ItemTemplate>
                    <div class="statistic d-flex align-items-center bg-white has-shadow">
                        <div class="icon bg-MatchPoint"><i class="fas fa-star"></i></div>
                        <div class="text">
                    ...
                    <div class="statistic d-flex align-items-center bg-white has-shadow">
                        <div class="icon bg-FlashPoint"><i class="fas fa-star"></i></div>
                        <div class="text">
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>Team A Carry Forward</th>
                                    <th>Team B Carry Forward</th>
    ...
    <asp:SqlDataSource ID="CarrySQL" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" SelectCommand="SELECT SUM(Total_Left_Point) AS TeamA, SUM(Total_Right_Point) AS TeamB, SUM(Total_Left_Point + Total_Right_Point) AS Total FROM Member" CancelSelectOnNullParameter="False"></asp:SqlDataSource>
    ...
    <asp:FormView ID="ServiceChargeFormView" runat="server" DataSourceID="Total_SChargeSQL" Width="100%">
        <ItemTemplate>
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="statistic d-flex align-items-center bg-white has-shadow">
                        <div class="icon bg-service"><i class="far fa-chart-bar"></i></div>
                        <div class="text">
                ...
                <div class="col-md-4">
                    <div class="statistic d-flex align-items-center bg-white has-shadow">
                        <div class="icon bg-net"><i class="far fa-chart-bar"></i></div>
                        <div class="text">
...
union
SELECT SUM(ISNULL(Commission_Amount,0)) AS Amount,   SUM(ISNULL(Tax_Service_Charge,0)) AS Tax_Service_Charge, SUM(ISNULL(Net_Amount,0)) AS Net FROM Member_Bouns_Records_Gen_UniLevel WHERE (CAST(Insert_Date AS DATE) BETWEEN ISNULL(@From_Date, '1-1-1000') AND ISNULL(@To_Date, '1-1-3000'))
union
SELECT SUM(ISNULL(Commission_Amount,0)) AS Amount,   SUM(ISNULL(Tax_Service_Charge,0)) AS Tax_Service_Charge, SUM(ISNULL(Net_Amount,0)) AS Net FROM Member_Bouns_Records_Gen_Retails WHERE (CAST(Insert_Date AS DATE) BETWEEN ISNULL(@From_Date, '1-1-1000') AND ISNULL(@To_Date, '1-1-3000'))
union
SELECT SUM(ISNULL(Amount,0)) AS Amount,   SUM(ISNULL(Tax_Service_Charge,0)) AS Tax_Service_Charge, SUM(ISNULL(Net_Amount,0)) AS Net FROM Member_AutoPlan_Bonus_Record WHERE (CAST(Insert_Date AS DATE) BETWEEN ISNULL(@From_Date, '1-1-1000') AND ISNULL(@To_Date, '1-1-3000'))
union
SELECT   SUM(ISNULL(DesignationBouns_Amount,0)) AS Amount,  SUM(ISNULL(DesignationBouns_Tax_Service_Charge,0)) AS Tax_Service_Charge,SUM(ISNULL(Net_Amount,0)) AS Net FROM  Member_Bouns_Records_Executive_Designation WHERE (CAST(InsertDate AS DATE) BETWEEN ISNULL(@From_Date, '1-1-1000') AND ISNULL(@To_Date, '1-1-3000'))) AS ALL_Table"
...
union
SELECT 'Generation Commission' as NAME, ISNULL(SUM(Commission_Amount),0) AS Amount, ISNULL(SUM(Tax_Service_Charge),0) AS Tax_Service_Charge, ISNULL(SUM(Net_Amount),0) AS Net FROM Member_Bouns_Records_Gen_UniLevel WHERE (CAST(Insert_Date AS DATE) BETWEEN ISNULL(@From_Date, '1-1-1000') AND ISNULL(@To_Date, '1-1-3000'))
union
...
union
SELECT 'Membership Bonus' as NAME, ISNULL(SUM(Amount),0) AS Amount, ISNULL(SUM(Tax_Service_Charge),0) AS Tax_Service_Charge, ISNULL(SUM(Net_Amount),0) AS Net FROM Member_AutoPlan_Bonus_Record WHERE (CAST(Insert_Date AS DATE) BETWEEN ISNULL(@From_Date, '1-1-1000') AND ISNULL(@To_Date, '1-1-3000'))
union
SELECT 'Executive Bonus' as NAME, ISNULL(SUM(DesignationBouns_Amount),0) AS Amount, ISNULL(SUM(DesignationBouns_Tax_Service_Charge),0) AS Tax_Service_Charge, ISNULL(SUM(Net_Amount),0) AS Net FROM  Member_Bouns_Records_Executive_Designation WHERE (CAST(InsertDate AS DATE) BETWEEN ISNULL(@From_Date, '1-1-1000') AND ISNULL(@To_Date, '1-1-3000'))"
        CancelSelectOnNullParameter="False">
        <SelectParameters>
            <asp:ControlParameter ControlID="From_TextBox" Name="From_Date" PropertyName="Text" />
            <asp:ControlParameter ControlID="TO_TextBox" Name="To_Date" PropertyName="Text" />
