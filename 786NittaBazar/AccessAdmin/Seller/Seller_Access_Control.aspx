<%@ Page Title="Seller Access Control" Language="C#" MasterPageFile="~/Basic.Master" AutoEventWireup="true" CodeBehind="Seller_Access_Control.aspx.cs" Inherits="NittaBazar.AccessAdmin.Seller.Seller_Access_Control" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <h3>Seller Access Control</h3>
    ...
    <div class="table-responsive">
        <asp:GridView ID="Member_GridView" runat="server" AutoGenerateColumns="False" DataKeyNames="UserName" DataSourceID="SellersSQL" CssClass="mGrid">
            <Columns>
        ...
        <asp:SqlDataSource ID="SellersSQL" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" SelectCommand="SELECT Registration.Name, Registration.UserName, User_Login_Info.Password, aspnet_Membership.Email, Registration.Phone, aspnet_Membership.IsApproved, aspnet_Membership.IsLockedOut, aspnet_Membership.CreateDate, aspnet_Membership.LastLoginDate, aspnet_Membership.LastPasswordChangedDate, Registration.RegistrationID FROM aspnet_Users INNER JOIN aspnet_Membership ON aspnet_Users.UserId = aspnet_Membership.UserId INNER JOIN Registration ON aspnet_Users.UserName = Registration.UserName INNER JOIN User_Login_Info ON Registration.UserName = User_Login_Info.UserName WHERE (Registration.Category = N'Seller')"
