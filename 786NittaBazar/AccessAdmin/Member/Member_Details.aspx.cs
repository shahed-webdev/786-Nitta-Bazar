    ...
    public partial class Member_Details : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                L_Total_Label.Text = "Team A Customers: " + dv.Count.ToString();

                DataView dv2 = (DataView)RightSQL.Select(DataSourceSelectArguments.Empty);
                R_Total_Label.Text = "Team B Customers: " + dv2.Count.ToString();
            }
        }
        ...
        protected void MemberDetailsFormView_ItemUpdated(object sender, FormViewUpdatedEventArgs e)
        {
            ...
            FileUpload CustomerFileUpload = (FileUpload)MemberDetailsFormView.FindControl("CustomerFileUpload");

            //Member Image
            #region Customer
            if (CustomerFileUpload.PostedFile != null && CustomerFileUpload.PostedFile.FileName != "")
            {
                string strExtension = System.IO.Path.GetExtension(CustomerFileUpload.FileName);
                if ((strExtension.ToUpper() == ".JPG") || (strExtension.ToUpper() == ".JPEG") || (strExtension.ToUpper() == ".PNG"))
                {
                    // Resize Image Before Uploading to DataBase
                    System.Drawing.Image imageToBeResized = System.Drawing.Image.FromStream(CustomerFileUpload.PostedFile.InputStream);
                    ...
                    cmd.Parameters.AddWithValue("@RegistrationID", MemberDetailsFormView.DataKey["RegistrationID"].ToString());
        ...
        protected void Joining_LimitButton_Click(object sender, EventArgs e)
        {
            Joining_LimitSQL.Update();
            Joining_Limit_TextBox.Text = "";
        }
        ...
        protected void Change_Referral_Button_Click(object sender, EventArgs e)
        {
            Change_ReferralSQL.Update();
