<%@ Page Title="Duplex Commission" Language="C#" MasterPageFile="~/Basic.Master" AutoEventWireup="true" CodeBehind="Duplex_Commission.aspx.cs" Inherits="NittaBazar.AccessAdmin.Bonus_Com.Duplex_Commission" %>
...
(Member.Left_Carry_Point &gt;= 250 AND Member.Right_Carry_Point &gt;= 250)
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <div class="table-responsive">
                                <asp:GridView ID="DateGridView" AllowSorting="true" runat="server" AutoGenerateColumns="False" CssClass="mGrid" DataKeyNames="Date" DataSourceID="DateSQL" AllowPaging="True">
                                    <Columns>
                                ...
                                <asp:GridView ID="Bouns_AchieversGridView" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="mGrid" DataSourceID="Bouns_AchieversSQL" AllowPaging="True" PageSize="60">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Member_Package_Short_Key" HeaderText="Package" SortExpression="Member_Package_Short_Key" />
                                ...
                                <asp:SqlDataSource ID="Bouns_AchieversSQL" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" SelectCommand="SELECT Member_Bouns_Records_Infinity_Matching.Matching_Point, Member_Bouns_Records_Infinity_Matching.Flash_Point, Member_Bouns_Records_Infinity_Matching.Carry_Point, Member_Bouns_Records_Infinity_Matching.Weak_Side, Member_Bouns_Records_Infinity_Matching.Amount, Member_Bouns_Records_Infinity_Matching.Tax_Service_Charge, Member_Bouns_Records_Infinity_Matching.Net_Amount, Member_Bouns_Records_Infinity_Matching.Insert_Date, Registration.UserName, Member_Package.Member_Package_Short_Key FROM Member_Bouns_Records_Infinity_Matching INNER JOIN Member ON Member_Bouns_Records_Infinity_Matching.MemberID = Member.MemberID INNER JOIN Registration ON Member.MemberRegistrationID = Registration.RegistrationID INNER JOIN Member_Package ON Member_Bouns_Records_Infinity_Matching.Package_Serial = Member_Package.Package_Serial 
WHERE        (CONVERT(date,Member_Bouns_Records_Infinity_Matching.Insert_Date) = @Date)
ORDER BY Member_Bouns_Records_Infinity_Matching.Net_Amount DESC">
                                    <SelectParameters>
